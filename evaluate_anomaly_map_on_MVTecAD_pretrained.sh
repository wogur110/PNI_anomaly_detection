...
python train_coreset_distribution.py --category bottle --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category cable --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category capsule --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category carpet --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category grid --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category hazelnut --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category leather --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category metal_nut --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category pill --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category screw --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category tile --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category toothbrush --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category transistor --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category wood --dataset_path ../dataset/MVTecAD
python train_coreset_distribution.py --category zipper --dataset_path ../dataset/MVTecAD
